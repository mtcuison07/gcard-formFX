...
public class CashSupplementRun extends Application {   
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        fxmlLoader.setLocation(getClass().getResource("CashSupplement.fxml"));

        /*SET PARAMETERS TO CLASS*/
        CashSupplementController instance = new CashSupplementController();
        ...
        primaryStage.setTitle("Cash Supplement");
